...
php ./generateDocs.php EnigmaOfTheApePeninsula
chromium --no-sandbox --headless --gpu --no-pdf-header-footer --print-to-pdf=./temp.pdf ./EnigmaOfTheApePeninsula.html
pdftk './temp.pdf' update_info_utf8 './EnigmaOfTheApePeninsula.txt' output '../EnigmaOfTheApePeninsula.pdf' compress
rm ./EnigmaOfTheApePeninsula.txt
rm ./temp.pdf
