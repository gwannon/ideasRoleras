...
$html = str_replace("♥", "<span style='color: red; style: inline-block; font-size: 14px; line-height: 6px;'>♥</span>", $html); 
$html = str_replace("♦", "<span style='color: red; style: inline-block; font-size: 14px; line-height: 6px;'>♦</span>", $html); 
$html = str_replace("♠", "<span style='color: black; text-shadow: 0px 0px 2px white; style: inline-block; font-size: 14px; line-height: 6px;'>♠</span>", $html); 
$html = str_replace("♣", "<span style='color: black; text-shadow: 0px 0px 2px white; style: inline-block; font-size: 14px; line-height: 6px;'>♣</span>", $html); 
...
if($argv[1] == 'CrimenCavernicola') {
  $metas = "InfoKey: Title\n";
  $metas .= "InfoValue: «Se ha pintado un crimen en las paredes» por Gwannon - Ver. 0.9\n\n";
  $metas .= "InfoKey: Subject\n";
  $metas .= "InfoValue: «Se ha pintado un crimen en las paredes» es un hack para 100 Million B.C. donde podrás resolver misterios al más puro estilo de las novelas de Agatha Christie. Versión 0.9\n\n";
