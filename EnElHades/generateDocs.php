...
if($argv[1] == 'EnElHades') {
  ...
  $metas .= "InfoValue: En el Hades es un juego de rol basadao en Firelights que el deberás explorar el inframundo para recuperar los recuerdos perdidos de tu amor. Versión 1\n\n";
