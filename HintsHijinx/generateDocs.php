...
/* Generamos Metas */
/* -------------------------------------------------------------- */
if($argv[1] == 'HintsHijinx' || $argv[1] == 'HintsHijinxBW') {
  $metas = "InfoKey: Title\n";
  $metas .= "InfoValue: «Se ha pintado un crimen en las paredes» por Gwannon - Ver. 1.0\n\n";
  $metas .= "InfoKey: Subject\n";
  $metas .= "InfoValue: «Se ha pintado un crimen en las paredes» es un hack para 100 Million B.C. donde podrás resolver misterios al más puro estilo de las novelas de Agatha Christie. Versión 1.0\n\n";
