...
## GM: Create a sinful soul

Roll or choose on the tables below.

|1d6|Lucifer demands the soul of a …|
|---|---|
|1|Clergy/Person of Faith|
|2|Multimillionaire/Politician|
|3|Scientist/Scholar|
|4|Celebrity/Actor/Actress|
|5|Artist/Writer/Musician|
|6|Assassin/Gangster/Criminal|

|1d6|Your victim needs/wants …|
|---|---|
|1|Money|
|2|Love|
|3|Power|
...
|2|Science/Art|
|3|Low-paying, alienating, and monotonous work|
|4|Liberal professions|
|5|Philanthropy/Humanitarian aid/Social issues|
|6|Religion/Pseudoscience/Sects|

|1d6|Lives in …|
|---|---|
|1|A luxurious penthouse/mansion/palace|
|2|An apartment in the city center|
|3|A small house in the suburbs/a modest apartment/townhouse|
|4|In a caravan park/campsite|
|5|In a hospital/sanatorium|
|6|The street/jail/lost in the woods|

It can be interesting and cathartic to base the sinful soul on a real person you want to annoy.

## GM: Run the game

The goal is to obtain the soul that Lucifer has requested. Let them investigate their victim and uncover their desires, vices, weaknesses, and strengths.

The adventures should typically have two parts: a first part where them investigates the victim both closely and from afar, and a second part where them tempts/torments them into selling their soul. Suggest information that might be useful to your devil, such as, "Them seem to be looking with interest at a painting in the exhibition," or "Them've hidden something in their pocket without anyone noticing," and ask what them want to do.
...
Ask questions and build on the answers. «Have you ever tempted/tormented a bishop? What happened?»

If you wish, let your player choose the eternal torment that their victim will suffer.
