...
$md = file_get_contents(__DIR__ . "/../EspirituProvidencia.md");
...
file_put_contents(__DIR__ . "/../EspirituProvidencia.html", $html);
...
$doc->loadHTMLFile(__DIR__ . "/../EspirituProvidencia.html");
