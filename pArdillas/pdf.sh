...
php ./generateDocs.php sKirrels
chromium --no-sandbox --headless --gpu --no-pdf-header-footer --print-to-pdf=./temp.pdf ./sKirrels.html
pdftk './temp.pdf' update_info_utf8 './sKirrels.txt' output '../sKirrels.pdf' compress
#rm ./sKirrels.html
rm ./temp.pdf
