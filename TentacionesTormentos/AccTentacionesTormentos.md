# Tentaciones y tormentos

«Tentaciones y tormentos» es un hack para 1 DJ y 1 PJ para el juego de rol «Lasers & Feelings» creado por [John Harper](https://johnharper.itch.io/lasers-feelings).

Interpretarás a un demonio que deberá tentar y atormentar a los mortales para conseguir su alma y con ello el favor de Lucifer y así ascender en la jerarquía del Infierno.

Para jugar a este juego necesitarás papel, lápiz y 3 dados de 6 caras.

## PJ: Crear tu personaje

1. Para **crear tu diablo** debes ponerle **un nombre**. Piensa en nombres clásicos diabólicos y añádele, quítale o cambiales letras, Azazel puede ser Puzazel, Uzuzel, Apazel, etc. Elige también **unos pronombres**.
...
Al final de cada partida, cuando entregas el alma del caído a Lucifer, este puede otorgarte una y solo una de sus «bendiciones».

Está **«bendicion» puede usarse** en situaciones extremas durante la sesión para **girar el valor de tu número**. De forma que un 2 y 3 pasa a un 5 y un 4 y 5 pasan a ser un 2.

Puedes gastar la «bendición» después de tirar los dados.
...
|1d6|Lucifer te exige el alma de une …|
|---|---|
|1|Clerigue/Persona de fe|
|2|Multimilonarie/Polítique|
|3|Cientifique/Estudiose|
|4|Famose/Actore|
|5|Artiste/Escritore/Músique|
|6|Asesine/Mafiose/Criminal|

|1d6|Tu víctima necesita/desea …|
|---|---|
|1|Dinero|
|2|Amor|
|3|Poder|
...
|1d6|y no puede resistirse a …|
|---|---|
|1|El juego|
|2|La belleza|
|3|Los secretos|
|4|La dominación/sumisión|
|5|Halagos y el peloteo|
|6|Las drogas|
...
|---|---|
|1|Un lujoso ático|
|2|Un apartamento en el centro|
|3|Una casita en los suburbios/pueblito|
|4|En un parque de caravanas|
|5|En un hospital|
|6|La calle|
