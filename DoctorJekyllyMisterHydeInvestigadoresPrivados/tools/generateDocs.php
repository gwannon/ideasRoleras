...
$md = file_get_contents(__DIR__ . "/../DoctorJekyllyMisterHydeInvestigadoresPrivados.md");
...
file_put_contents(__DIR__ . "/../AccDoctorJekyllyMisterHydeInvestigadoresPrivados.md", str_replace(["\sp", "\sc", "\sinc", "\conc", "&nbsp;\n", "\n\n\n"], "", $md));
...
file_put_contents(__DIR__ . "/../DoctorJekyllyMisterHydeInvestigadoresPrivados.html", $html);
...
$doc->loadHTMLFile(__DIR__ . "/../DoctorJekyllyMisterHydeInvestigadoresPrivados.html");
